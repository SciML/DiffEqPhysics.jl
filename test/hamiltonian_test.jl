...
prob_1 = DynamicalODEProblem(acc, vel, p0, q0, (0.0, 10.0))

@testset "prob1($h)" for h in (H, (dp, dq))
    prob1 = HamiltonianProblem(h, p0, q0, (0.0, 10.0))
...
prob_2 = DynamicalODEProblem(acc, vel, p0, q0, (0.0, 10.0))

@testset "prob2($h)" for h in (H4, (dp, dq))
    prob2 = HamiltonianProblem(h, p0, q0, (0.0, 10.0))
...
prob_3 = DynamicalODEProblem(acc, vel, p0, q0, (0.0, 10.0))

@testset "prob3($h)" for h in (H, (dp, dq))
    prob3 = HamiltonianProblem(h, p0, q0, (0.0, 10.0))
...
prob_4 = DynamicalODEProblem(acc, vel, p0, q0, (0.0, 10.0))

@testset "prob4($h)" for h in (H4, (dp, dq))
    prob4 = HamiltonianProblem(h, p0, q0, (0.0, 10.0))
