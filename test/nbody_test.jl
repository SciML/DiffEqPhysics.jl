...
@testset "NBodyProblem Test" begin
    G = 2.95912208286e-4
    M = [
        1.00000597682, 0.000954786104043, 0.000285583733151,
        0.0000437273164546, 0.0000517759138449, 1 / 1.3e8,
    ]
    invM = inv.(M)
    planets = ["Sun", "Jupiter", "Saturn", "Uranus", "Neptune", "Pluto"]

    pos_x = [0.0, -3.5023653, 9.0755314, 8.310142, 11.4707666, -15.5387357]
    ...
    vel_x = [0.0, 0.00565429, 0.00168318, 0.00354178, 0.0028893, 0.00276725]
    vel_y = [0.0, -0.0041249, 0.00483525, 0.00137102, 0.00114527, -0.00170702]
